...
<div className='container'>
  <div className='calculator'>
    <form action=''>
      ...
      <div>
        <input type='button' value='AC'onClick={e=>setValue('')} className='ac'></input>
        <input type='button' value='DE' onClick={e=>setValue(value.slice(0, -1))} className='de'></input>
        <input type='button' value='.' onClick={e => setValue(value + e.target.value)} className='dot'></input>
        <input type='button' value='/' onClick={e => setValue(value + e.target.value)} className='div'></input>
      </div>
      <div>
        ...
        <input type='button' value='*' onClick={e => setValue(value + e.target.value)} className='mul'></input>
      </div>
      <div>
        ...
        <input type='button' value='+' onClick={e => setValue(value + e.target.value)} className='add'></input>
      </div>
      <div>
        ...
        <input type='button' value='-' onClick={e => setValue(value + e.target.value)} className='sub'></input>
      </div>
      <div>
